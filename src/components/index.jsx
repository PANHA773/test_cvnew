    ...
    >
      ...
      >
        ...
        <motion.p className="text-lg text-stone-300 mb-4" variants={item}>
          I'm a <span className="text-indigo-400 font-semibold">Full-Stack Developer</span> passionate about crafting modern, responsive, and scalable applications.
        </motion.p>

        <motion.p className="text-stone-400 mb-6" variants={item}>
          I work with technologies like <strong>React, Laravel, Flutter, MySQL, PHP, Tailwind</strong> and more—building full web and mobile experiences.
        </motion.p>
      ...
      >
        <img
          src={profilePic}
          alt="Panha"
          className="w-full max-w-2xl h-auto object-cover rounded-lg shadow-lg shadow-indigo-500/20"
        />
      </motion.div>
    </section>
  );
